...
export const defaultSetting = ${JSON.stringify({ ...defaultSetting, ...form.getFieldsValue() }, null, 2)} as SystemSettingType;
      ...
      >
        ...
        >
          ...
          <Form.Item label="表格查询类型" name="filterType">
            <Select
          ...
          <Form.Item label="表单显示方式" name="showFormType">
            <Select
          ...
          <Form.Item label="水印" name="showWatermark" valuePropName="checked">
            <Switch
              onChange={(value) => {
          ...
          {showWatermark && (
            <Form.Item label="水印位置" name="watermarkPos">
