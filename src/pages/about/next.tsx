        ...
        <Row gutter={32} className="flex flex-col">
          <Col span={4}>
            ...
            <Space className="mt-2">
              ...
              <Tag color="#7c4dff4c">
                <span className=" text-[#7c4dff]">桌面端</span>
              </Tag>
              <Tag color="#7c4dff4c">
          ...
          <Col className="mt-3">
            ...
            通过将 Chromium 和 Node.js 嵌入到其二进制文件中，Electron
            允许你维护一个 JavaScript 代码库并创建可在 Windows、macOS 和 Linux
            上运行的跨平台应用 — 无需原生开发经验。
          </Col>
      ...
      <Space direction="vertical" size="middle" style={{ display: 'flex' }}>
        <Row gutter={32} className="flex flex-col">
          <Col span={4}>
            ...
            <Space className="mt-2">
              <Tag color="#7c4dff4c">
                <span className=" text-[#7c4dff]">后端语言</span>
              </Tag>
              <Tag color="#7c4dff4c">
                <span className=" text-[#7c4dff]">高并发</span>
              </Tag>
              <Tag color="#7c4dff4c">
                <span className=" text-[#7c4dff]">跨平台</span>
              </Tag>
            </Space>
          </Col>
          <Col className="mt-3">
            Go 富有表现力、简洁、干净且高效。它的并发性
            通过各种机制，可以轻松编写充分利用多核的程序
            和联网的机器，而其新颖的类型系统使灵活和 模块化程序构建。Go
            可以快速编译为机器代码，但具有
            垃圾回收的便利性和运行时反射的强大功能。这是一个
            快速、静态类型、编译语言，感觉像是动态类型的， 解释性语言。
          </Col>
          <Col className="mt-3 flex items-center ">
            <p>
              <GolangIcon />
              ...
              <span className="tracking-wide"> 发布在</span>
              <a href="https://golang.google.cn/doc/">
                {' '}
