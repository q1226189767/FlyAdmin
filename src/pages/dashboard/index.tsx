      ...
      <Row gutter={[16, 16]}>
          ...
          <div className=" dark:bg-[rgb(33,41,70)] w-[100%] bg-[rgb(94,53,177)] overflow-hidden h-[241px] relative rounded-md bg-card p-[32px] box-border">
            ...
            <div className="mt-[30px] text-[rgba(229,224,216,0.85)] text-[16px] flex gap-[24px]">
              ...
              <div className="flex items-center">
                ...
                <span className="ml-[12px]">15%</span>
        ...
        <Col lg={24} xl={8} className="w-[100%]">
          <div className=" dark:bg-[rgb(33,41,70)] bg-[rgb(30,136,229)] theme1 overflow-hidden h-[241px] relative rounded-md bg-card p-[32px] box-border">
            ...
            <Divider className="dark:bg-[rgb(189,200,240)] bg-[rgb(227,232,239)] opacity-[0.2] mt-[9px] mb-[16px]" />
            <div className="text-[rgba(229,224,216,0.85)] text-[16px]">
        ...
        <Col lg={24} xl={8} className="w-[100%]">
          <div className=" dark:bg-[rgb(33,41,70)] bg-[rgb(94,53,177)] theme2 overflow-hidden h-[241px] relative rounded-md bg-card p-[32px] box-border">
            ...
            <div className="mt-[16px] text-[rgba(229,224,216,0.85)] text-[16px] flex gap-[24px]">
              <DemoTinyColumn />
            </div>
            <Divider className="dark:bg-[rgb(189,200,240)] bg-[rgb(227,232,239)] opacity-[0.2] mt-[8px] mb-[16px]" />
            <div className="text-[rgba(229,224,216,0.85)] text-[16px]">
        ...
        <Col className="w-[100%]" lg={24} xl={8}>
          <div className=" dark:bg-[rgb(33,41,70)] bg-white h-[600px] rounded-md p-[24px] relative">
            ...
            <div className="py-[24px]">
              ...
              <Divider className="dark:bg-[rgb(189,200,240)] bg-[rgb(227,232,239)] dark:opacity-[0.2] my-[10px]" />
              <div>
                <div className="flex justify-between items-center">
                  <span className="dark:text-[rgb(189,200,240)] text-[rgb(54,65,82)]font-medium">
                    {t('WAiyAuwV' /* 合肥分店 */)}
